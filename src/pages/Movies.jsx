    ...
    <>
      ...
      <div className="mainx">
        ...
        <div className="top">
          ...
          <p id="release">{datax.original_language ? datax.original_language.toUpperCase() : ""}</p>
          </div>
        </div>
        {<div className="main__right"   >
          <img src={`https://image.tmdb.org/t/p/w500/${datax.backdrop_path}`} alt={datax.original_title} />
        </div>}
      </div>
    </>
  );
